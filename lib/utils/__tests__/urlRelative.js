...
test('html file', () => {
  expect(relative('/index.html', '/css/style.css')).toBe('css/style.css')
  expect(relative('/index.html/', '/css/style.css')).toBe('../css/style.css')
  expect(relative('/g/xxx.html', '/css/ddd/xxx/style.css')).toBe('../css/ddd/xxx/style.css')
  expect(relative('/a/b/c/d/xxx.html', '/css/x/style.css')).toBe('../../../../css/x/style.css')
})
