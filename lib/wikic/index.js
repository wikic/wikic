  ...
  watch() {
    chokidar
      ...
      .on('change', (filePath) => {
        ...
        Object.assign(matchess, this.config.watchHandlers)
        if (runBuiltInWatchHandler(filePath, matchess, this) !== false) return
        if (runCustomWatchHandler(filePath, matchess.custom, this) !== false) return
